...
config:
	...
	@echo "cmake -Wno-dev -D$(PROJECT_CAP)_BUILD_EXAMPLES=ON -D$(PROJECT_CAP)_ENABLE_TESTS=ON -D$(PROJECT_CAP)_ENABLE_LQR=ON -D$(PROJECT_CAP)_ENABLE_MPC=ON .."
	@cd $(BUILD_DIR) && cmake -Wno-dev -D$(PROJECT_CAP)_BUILD_EXAMPLES=ON -D$(PROJECT_CAP)_ENABLE_TESTS=ON -D$(PROJECT_CAP)_ENABLE_LQR=ON -D$(PROJECT_CAP)_ENABLE_MPC=ON ..
