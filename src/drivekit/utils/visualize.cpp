...
namespace drivekit {
    namespace visualize {
        ...
        // Show a single path
        void show_path(std::shared_ptr<rerun::RecordingStream> rec, const Path &path, const std::string &entity_path,
        ...
        void show_goal(std::shared_ptr<rerun::RecordingStream> rec, const Goal &goal, const std::string &entity_path,
                       const rerun::Color &color) {
