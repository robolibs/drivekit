...
namespace navcon {
    namespace pred {
        ...
        VelocityCommand DWAFollower::compute_control(const RobotState &, const Goal &, const RobotConstraints &, double, const WorldConstraints *) {
            VelocityCommand cmd;
            cmd.valid = false;
