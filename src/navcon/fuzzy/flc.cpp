...
namespace navcon {
    namespace fuzzy {
        ...
        VelocityCommand FuzzyFollower::compute_control(const RobotState &, const Goal &, 
                                                       const RobotConstraints &, double, 
        ...
        void FuzzyFollower::set_flc_config(const FLCConfig &config) {
            flc_config_ = config;
        }

        FuzzyFollower::FLCConfig FuzzyFollower::get_flc_config() const {
            return flc_config_;
        }
