...
int main() {
    ...
    std::cout << "Start: (" << start.point.x << ", " << start.point.y << ") heading " << start.angle.yaw << " rad"
              << std::endl;
    ...
    std::cout << "Shortest Dubins path: " << shortest_dubins.name << " (length: " << shortest_dubins.total_length << ")"
              << std::endl;
    ...
    if (!shortest_dubins.waypoints.empty()) {
        ...
        std::cout << "Dubins start: (" << first.point.x << ", " << first.point.y << ", " << first.angle.yaw << ")"
                  << std::endl;
        std::cout << "Dubins end: (" << last.point.x << ", " << last.point.y << ", " << last.angle.yaw << ")"
                  << std::endl;
        std::cout << "Expected end: (" << end.point.x << ", " << end.point.y << ", " << end.angle.yaw << ")"
                  << std::endl;
        ...
        std::cout << "Heading error: " << heading_error << " radians (" << heading_error * 180.0 / M_PI << " degrees)"
                  << std::endl;
    }
    ...
    std::cout << "Shortest Reeds-Shepp path: " << shortest_rs.name << " (length: " << shortest_rs.total_length << ")"
              << std::endl;
    ...
    if (!shortest_rs.waypoints.empty()) {
        ...
        std::cout << "RS start: (" << first_rs.point.x << ", " << first_rs.point.y << ", " << first_rs.angle.yaw << ")"
                  << std::endl;
        std::cout << "RS end: (" << last_rs.point.x << ", " << last_rs.point.y << ", " << last_rs.angle.yaw << ")"
                  << std::endl;
        std::cout << "RS expected end: (" << end.point.x << ", " << end.point.y << ", " << end.angle.yaw << ")"
                  << std::endl;
        ...
        std::cout << "RS heading error: " << rs_heading_error << " radians (" << rs_heading_error * 180.0 / M_PI
                  << " degrees)" << std::endl;
    }
