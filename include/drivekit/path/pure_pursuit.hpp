...
namespace drivekit {
    namespace path {
        ...
        /// Uses a lookahead point on the path to compute steering commands.
        class PurePursuitFollower : public Controller {
          ...
          private:
            ...
            /// Find intersection between circle and line segment.
            inline std::optional<Point> find_circle_segment_intersection(const Point &circle_center, double radius,
