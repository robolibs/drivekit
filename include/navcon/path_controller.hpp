...
public:
    ...
    PathController(FollowerType follower_type = FollowerType::PURE_PURSUIT, double min_turning_radius = 2.0) 
    ...
    turners::ReedsShepp* get_reeds_shepp() const { return reeds_shepp_.get(); }
